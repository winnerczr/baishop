 ...
 * @author Linpn
 */
public class HttpInvokerAuthsProxyFactoryBean 
			extends org.springframework.remoting.httpinvoker.HttpInvokerProxyFactoryBean implements Serializable {
	...
	private HttpInvokerAuthsProxyFactoryBean(){
		this.setPrefix("");
		this.setServiceUrl("");
