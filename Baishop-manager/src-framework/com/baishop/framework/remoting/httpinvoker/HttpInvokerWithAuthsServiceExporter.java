 ...
 * @author Linpn
 */
public class HttpInvokerWithAuthsServiceExporter 
		extends HttpInvokerServiceExporter implements Serializable {
	
	private static final long serialVersionUID = -4009200224393352085L;
	
	private static JSONObject configurer;
	
	private HttpInvokerWithAuthsServiceExporter() {
	...
	public void handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(user==null || password==null)
				throw new NestedServletException("User name or password is empty, if the client use HttpInvokerWithAuthsProxyFactoryBean?");
