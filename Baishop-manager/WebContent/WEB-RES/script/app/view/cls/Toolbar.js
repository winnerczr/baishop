 ...
 */
Ext.define('Baishop.view.cls.Toolbar', {
    ...
    initComponent: function() {
        ...
        this.items = this.items.concat([
            { xtype: 'tbfill' },
            {
                ...
                margin: '0 5 0 0',
                padding: '0 0 5 0',
                checked: Baishop.Settings.get("hideInherited"),
                handler: function(el) {
    ...
    createMemberButton: function(cfg) {
        ...
        return Ext.create('Baishop.view.HoverMenuButton', {
            text: cfg.text,
            cls: 'icon-'+cfg.type,
    ...
    hideInherited: function(hide) {
        Baishop.Settings.set("hideInherited", hide);
