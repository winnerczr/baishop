/**
 * Menu shown by {@link Baishop.view.HoverMenuButton}.
 */
Ext.define('Baishop.view.HoverMenu', {
        ...
        this.tpl = new Ext.XTemplate(
            ...
            '</table>',
            {
                ...
                renderLink: function(values) {
                    ...
                    return Ext.String.format('<a href="#/{0}" rel="{0}" class="docClass">{1} {2}</a>', url, label, stat);
                }
            }
        );
