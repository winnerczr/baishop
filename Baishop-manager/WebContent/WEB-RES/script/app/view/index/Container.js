 ...
 */
Ext.define('Baishop.view.index.Container', {
    ...
    initComponent: function() {
        ...
        var tpl = new Ext.XTemplate(
            ...
            Baishop.live ? '' : '<div class="notice">Use <a href="http://docs.sencha.com/ext-js/4-0">http://docs.sencha.com/ext-js/4-0</a> for up to date documentation and features</div>',
            ...
            '</tpl>',
            {
                renderClasses: function(category) {
                    return Ext.Array.map(data.categories[category].classes, function(cls) {
                        return Ext.String.format('<a href="#/{0}" rel="{0}" class="docClass">{0}</a>', cls);
                    }).join("\n");
                }
            }
        );
